    ...
    <div className="flex flex-col min-h-full w-full relative bg-slate-50 dark:bg-[#121212] transition-colors duration-300">
        ...
        <header className="flex justify-between items-center mb-8 relative z-10 text-[#004F71]">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <h2 className="text-lg font-black tracking-tight">Edwin</h2>
            </div>
          </div>
          <button className="p-2.5 rounded-full bg-white/20 hover:bg-white/30 transition-colors">
      ...
      <div className="px-6 mb-8">
        ...
        <div className="grid grid-cols-4 gap-4">
          <ActionIcon icon={<Send size={26} />} label="Transfert" />
          <ActionIcon icon={<Download size={26} />} label="Retrait" />
          <ActionIcon icon={<Phone size={26} />} label="Crédit" />
          <ActionIcon icon={<Wifi size={26} />} label="Forfaits" />
          <ActionIcon icon={<CreditCard size={26} />} label="MoMoPay" />
          <ActionIcon icon={<Landmark size={26} />} label="Banque" />
          <ActionIcon icon={<FileText size={26} />} label="Factures" />
      ...
      <div className="px-6 pb-32">
        <div className="flex justify-between items-center mb-4">
          ...
          <span className="text-sm font-bold text-[#004F71] dark:text-[#FFCC00] cursor-pointer">Voir tout</span>
        </div>
